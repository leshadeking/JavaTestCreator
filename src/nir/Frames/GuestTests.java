 ...
 * @author Alexkcey
 */
public class GuestTests extends javax.swing.JFrame {

    /**
     * Creates new form GuestTests
     */
    private SQL sqlReq = new SQL();
    public GuestTests(){
        initComponents();
        int i = 0;
        List<String> list = sqlReq.getNames("SELECT Test_name FROM tests");
        while (list.size()>i)
        {
    ...
    private void jList2ValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jList2ValueChanged
       jTextArea1.setText(sqlReq.getStrigSQL("SELECT Test_description FROM tests WHERE Test_name = '" + jList2.getSelectedValue()+"'"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuestTests.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new GuestTests().setVisible(true);
